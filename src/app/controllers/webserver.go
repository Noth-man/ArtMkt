...
func createMultitemplate() multitemplate.Renderer {
	...
	render.AddFromFiles("campaign1", "app/views/base.html", "app/views/campaign/campaign1.html")
	render.AddFromFiles("campaign2", "app/views/base.html", "app/views/campaign/campaign2.html")
	render.AddFromFiles("campaign3", "app/views/base.html", "app/views/campaign/campaign3.html")
...
func StartWebServer() {
	...
	//--------------------campaign.go--------------------
	CSRFGroup.GET("/campaign/:number", campaign)
	//--------------------top.go--------------------
	//topページ
	CSRFGroup.GET("/", top)
	...
	CSRFGroup.GET("/signupinputcheck/:karitoken", SignupInputCheck)
	//メール送信
